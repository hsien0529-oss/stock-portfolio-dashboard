const document = { querySelectorAll: () => [], getElementById: () => ({ style: {}, classList: { remove: ()=>{}, add: ()=>{} }, setAttribute: ()=>{} }), addEventListener: ()=>{} }; const window = { location: { protocol: "file:" }, addEventListener: ()=>{} }; const localStorage = { getItem: ()=>null, setItem: ()=>{} };
// ============================================================
...
init().catch(console.error); setTimeout(() => console.log('TotalMV:', document.getElementById('gsMV') ? document.getElementById('gsMV').textContent : 'missing'), 1000);